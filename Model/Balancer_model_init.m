...
Ri					=	0.025;							% Cell internal resistance, ohm
Q0_nominal			=	0.6 * 3600;						% Initial charge, coulomb (baseline)
...
load('Samsung-25R', 'Voc');								% Load OCV curve from file
